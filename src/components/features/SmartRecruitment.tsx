    ...
    <section className="flex flex-col md:flex-row justify-center my-12 bg-white text-gray-800 px-4 md:px-8 lg:px-16 py-12">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-start text-left mb-10 md:mb-0 md:pr-10 lg:pr-20 lg:space-y-12">
        ...
        <p className="text-base text-[16px] text-[#535862] font-ibm-plex-sans mb-6">
          EduSight.ai offers an intelligent AI recruitment chatbot integrated
          seamlessly with university websites to answer prospective student
          queries accurately and effectively, coupled with a powerful analytics
          dashboard for staff.
          <br />
          <br />
          Flexible pricing options designed to support institutions at every
          stage of their recruitment journey, making it easier to scale and
          succeed.
        </p>
        <p className="text-base lg:text-lg text-gray-600 mb-8"></p>
        <RippleButton
      ...
      <div className="w-full md:w-1/2 flex justify-center items-end">
        {" "}
        {/* Increased height and aligned items to the bottom */}
        <Image
