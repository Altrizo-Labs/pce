  ...
  return (
    <div className="rounded-t-[32px] h-fit bg-gradient-to-b from-primary from-10% via-primary/20 to-100% to-transparent p-5 lg:p-10 relative overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 relative z-10">
        ...
        >
          Projects Cost Engineering (Pvt) Ltd <br className="hidden lg:block" /> Expert Quantity Surveying and Cost Engineering Services
        </motion.p>
        ...
        <div className="flex-[0.42] flex flex-col justify-between">
          ...
          >
            Providing expert Quantity Surveying and Cost Engineering services with 25 years of experience in the Middle East, adhering to strict international business standards.
          </motion.p>
